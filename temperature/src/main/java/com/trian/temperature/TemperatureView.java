...
public class TemperatureView extends View {
    ...
    public void init(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.Temperature);
        outerCircleRadius = typedArray.getDimension(R.styleable.Temperature_radius, 20f);
        int outerColor = typedArray.getColor(R.styleable.Temperature_outerColor, Color.GRAY);
        int middleColor = typedArray.getColor(R.styleable.Temperature_middleColor, Color.WHITE);
        int innerColor = typedArray.getColor(R.styleable.Temperature_innerColor, Color.RED);
        ...
        graduationPaint.setTextSize(DisplayUtil.dip2px(getContext(), GRADUATION_TEXT_SIZE));
